...
\begin{center}
\leavevmode
\includegraphics[width=172pt]{classDeriClient__coll__graph}
\end{center}
\end{figure}
...
void \mbox{\hyperlink{classDeriClient_a58e01598a50fffa811230385a4fbd39d}{subscribe\+\_\+to\+\_\+symbol}} (const std\+::string \&instrument, std\+::function$<$ void(const std\+::string \&)$>$ callback=nullptr)
\begin{DoxyCompactList}\small\item\em Subscribe to symbol for real-\/time updates. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classDeriClient_a6b151ab37c85656563bda3dbf1db61f1}{unsubscribe\+\_\+from\+\_\+symbol}} (const std\+::string \&instrument)
...
moodycamel\+::\+Concurrent\+Queue$<$ std\+::string $>$ {\bfseries write\+\_\+queue}
\item 
...
\item 
\mbox{\Hypertarget{classDeriClient_ad3c7d16f4aac817f2aadf6d65b8580ed}\label{classDeriClient_ad3c7d16f4aac817f2aadf6d65b8580ed}} 
\mbox{\hyperlink{classBufferPool}{Buffer\+Pool}} {\bfseries buffer\+\_\+pool}
...
\end{DoxyReturn}
\mbox{\Hypertarget{classDeriClient_a58e01598a50fffa811230385a4fbd39d}\label{classDeriClient_a58e01598a50fffa811230385a4fbd39d}} 
\index{DeriClient@{DeriClient}!subscribe\_to\_symbol@{subscribe\_to\_symbol}}
\index{subscribe\_to\_symbol@{subscribe\_to\_symbol}!DeriClient@{DeriClient}}
\doxysubsubsection{\texorpdfstring{subscribe\_to\_symbol()}{subscribe\_to\_symbol()}}
{\footnotesize\ttfamily void Deri\+Client\+::subscribe\+\_\+to\+\_\+symbol (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{instrument,  }\item[{std\+::function$<$ void(const std\+::string \&)$>$}]{callback = {\ttfamily nullptr} }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em instrument} & channel name \\
\hline
{\em callback} & Optional function to call when updates are received \\
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classDeriClient_a6b151ab37c85656563bda3dbf1db61f1}\label{classDeriClient_a6b151ab37c85656563bda3dbf1db61f1}} 
\index{DeriClient@{DeriClient}!unsubscribe\_from\_symbol@{unsubscribe\_from\_symbol}}
\index{unsubscribe\_from\_symbol@{unsubscribe\_from\_symbol}!DeriClient@{DeriClient}}
\doxysubsubsection{\texorpdfstring{unsubscribe\_from\_symbol()}{unsubscribe\_from\_symbol()}}
{\footnotesize\ttfamily void Deri\+Client\+::unsubscribe\+\_\+from\+\_\+symbol (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{instrument }\end{DoxyParamCaption})}
